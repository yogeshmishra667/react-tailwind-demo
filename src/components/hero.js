...
import bgImg from '../assets/undraw_mobile_development_re_wwsn.svg';
//import { bgImg } from '../assets/headway-5QgIuuBxKwM-unsplash.jpg';
const Hero = () => {
  return (
    <div
      name="home"
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          <p className="text-2xl">Unique & aesthetic solution</p>
        ...
        >
          {/* md:-translate-x-1/2 - anything above the md then use translate */}
          <p>Data Services</p>
          <div className="flex justify-between flex-wrap px-4">
            <p className="flex px-4 py-2 text-slate-500">
              <CloudArrowDownIcon className="h-6 text-indigo-600" /> App
              Security
            </p>
            <p className="flex px-4 py-2 text-slate-500">
